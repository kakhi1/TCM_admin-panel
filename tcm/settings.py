...
# JAZZMIN UI CONFIGURATION (SINGLE DEFINITION - FIXED!)
JAZZMIN_UI_TWEAKS = {
    "theme": "simplex",
    "dark_mode_theme": "darkly",
}
...
JAZZMIN_SETTINGS = {
    # Site branding
    "site_title": "TCM Admin",
    "site_header": "TCM Administration",
    "site_brand": "TCM",

    # Updated Ordering: Order by the "Virtual Apps"
    "order_with_respect_to": [
        "ui_core",       # Core Blood Markers & Pattern Mapping
        "ui_medical",    # Medical Conditions & Symptoms
        "ui_pharma",     # Medications & Supplements
    ...
    # REMOVED custom_css and custom_js - they were breaking static files
    # If you need custom CSS/JS, add them back ONLY if the files exist in:
    # static/admin/css/jazzmin_table_scroll.css
    # static/admin/js/jazzmin_table_scroll.js
}
...
# Use CompressedManifestStaticFilesStorage for production
# This creates a manifest file and serves compressed files
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

# Static files directories - ONLY include if you have a 'static' folder at project root
# Comment this out if you don't have custom static files
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
